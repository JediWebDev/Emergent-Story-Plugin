 ...
 * ------------------------------Text Codes------------------------------------
 * In the list window, you can use the following text codes:
 * %color - will change text to be the profession's color
 * %name - will show the profession's display name
 * %level - will show the profession's current level
 * %maxlevel - will show the profession's maximum level
 * ----------------------------Plugin Commands---------------------------------
 * • Call Scene
 ...
 * discovering a profession. In the toast preset, you can use the following
 * text codes:
 ...
 * Add a background image to any window in your game, including scrolling and
 * animated parallax images. This integration adds an easy no-code way to use
 * these features with the profession windows.
 *
 * [CGMZ] Window Settings
 * Customize any window's windowskin, tone, style, and more. This integration
 * adds an easy no-code way to implement these customizations for the
 * profession scene windows.
 * ------------------------------Saved Games-----------------------------------
 ...
 * rename the js file.
 * --------------------------Latest Version------------------------------------
 * Hi all, this version adds profession specific toast options, so you can
 * now have completely different toast windows for each profession if desired.
 * If not set up, toast window will fall back to the default toasts set up in
 * the global parameters.
 *
 * This update also moved exp curve data out of save data, so you can now edit
 * the exp curve for professions in the plugin manager and have your edits
 * show up in your saved games.
 *
 * Version 1.8.0
 ...
 * @parent Window Options
 * @type number
 * @desc Amount of blank vertical space (in pixels) for the Custom Space display line item
 * @default 6
 *
 * @param Max Category Columns
 * @parent Window Options
 * @type number
 * @desc Maximum amount of category columns to display per row in category window
 * @default 4
 *
 ...
 * @default left
 *
 * @param List Window Text
 * @parent Text Options
 * @default %color%name\c[0] (%level/%maxlevel)
 * @desc Text to show in the list window for each profession
 *
 * @param Level Text
 * @parent Text Options
 * @default Level: 
 ...
 * @param Integrations
 *
 * @param Level Up Toast
 * @parent Integrations
 * @desc [CGMZ] Toast Manager preset id to show when a profession levels up
 *
 * @param Discover Toast
 * @parent Integrations
 * @desc [CGMZ] Toast Manager preset id to show when a profession is discovered
 *
 ...
 * @parent Integrations
 * @desc [CGMZ] Window Settings preset to use for the Professions scene - category window
 *
 * @param List Window Settings
 * @parent Integrations
 * @desc [CGMZ] Window Settings preset to use for the Professions scene - list window
 *
 * @param Total Window Settings
 * @parent Integrations
 * @desc [CGMZ] Window Settings preset to use for the Professions scene - total window
 *
 * @param Display Window Settings
 * @parent Integrations
 * @desc [CGMZ] Window Settings preset to use for the Professions scene - display window
 *
 * @param Category Window Background
 * @parent Integrations
 * @desc [CGMZ] Window Backgrounds preset to use for the Professions scene - category window
 *
 * @param List Window Background
 * @parent Integrations
 * @desc [CGMZ] Window Backgrounds preset to use for the Professions scene - list window
 *
 * @param Total Window Background
 * @parent Integrations
 * @desc [CGMZ] Window Backgrounds preset to use for the Professions scene - total window
 *
 * @param Display Window Background
 * @parent Integrations
 * @desc [CGMZ] Window Backgrounds preset to use for the Professions scene - display window
*/
/*~struct~Profession:
 * @param Name
 * @desc The name of the profession.
 ...
 * @type struct<SE>
 * @desc The sound effect to play when displaying a toast window for the profession. Requires [CGMZ] Toast Manager
 *
 * @param Level Up Toast Preset
 * @desc A [CGMZ] Toast Manager preset id to use for just this profession when leveling up
 *
 * @param Discover Toast Preset
 * @desc A [CGMZ] Toast Manager preset id to use for just this profession when discovered
 */
/*~struct~SE:
 * @param name
 * @type file
 ...
 * <cgmzprofbuff:profName,buffAmount,frameCount,stackable>
 * - profName debe ser el nombre de la profesión (se distingue entre 
 *   mayúsculas y minúsculas)
 * - buffAmount debe ser un número que se agregará al nivel de la profesión
 * - frameCount debe ser un número que es cuántos fotogramas durará el 
 *   beneficio (60f = 1 sec)
 ...
 *
 * Estos beneficios de armas y armaduras son permanentes mientras están
 * equipados y se acumulan.
 *
 * Note for actor-specific professions: add -actorId onto the profession name.
 * For example, if your profession has name Mining and is for Actor ID 2,
 * you would put Mining-2 as the profession name,
 ...
 *
 * • Cambiar nivel
 * Le permite establecer, agregar o restar niveles de la profesión
 * proporcionada.
 *
 ...
 * CGMZ_Professions.js
 * Esto es lo que viene cuando se descarga. El nombre de archivo se usa para
 * cargar parámetros y ejecutar comandos de complemento. Si lo cambia, las
 * cosas comenzarán a comportarse incorrectamente y su juego probablemente se
 * bloquee. No cambie el nombre del archivo js.
 * --------------------------Latest Version------------------------------------
 * Hi all, this version adds profession specific toast options, so you can
 * now have completely different toast windows for each profession if desired.
 * If not set up, toast window will fall back to the default toasts set up in
...
CGMZ.Versions["Professions"] = "1.8.0";
CGMZ.Professions = {};
...
CGMZ.Professions.DiscoverToast = CGMZ.Professions.parameters["Discover Toast"];
CGMZ.Professions.LevelUpToast = CGMZ.Professions.parameters["Level Up Toast"];
...
CGMZ.Professions.ListWindowSettings = CGMZ.Professions.parameters["List Window Settings"];
CGMZ.Professions.DisplayWindowSettings = CGMZ.Professions.parameters["Display Window Settings"];
CGMZ.Professions.TotalWindowSettings = CGMZ.Professions.parameters["Total Window Settings"];
CGMZ.Professions.CategoryWindowSettings = CGMZ.Professions.parameters["Category Window Settings"];
CGMZ.Professions.ListWindowBackground = CGMZ.Professions.parameters["List Window Background"];
CGMZ.Professions.DisplayWindowBackground = CGMZ.Professions.parameters["Display Window Background"];
CGMZ.Professions.TotalWindowBackground = CGMZ.Professions.parameters["Total Window Background"];
CGMZ.Professions.CategoryWindowBackground = CGMZ.Professions.parameters["Category Window Background"];
...
CGMZ.Professions.ListWindowText = CGMZ.Professions.parameters["List Window Text"];
...
CGMZ.Professions.CustomSpace = Number(CGMZ.Professions.parameters["Custom Space"]);
CGMZ.Professions.MaxCategoryColumns = Number(CGMZ.Professions.parameters["Max Category Columns"]);
...
CGMZ_Profession.prototype.initialize = function(profession, actorId = "") {
	...
	this._description = profession.Description;
	this._exp = 0;
	this._buffs = {};
...
//-----------------------------------------------------------------------------
// Get temp profession data
//-----------------------------------------------------------------------------
CGMZ_Profession.prototype.professionData = function() {
	return $cgmzTemp.getProfessionTempData(this.getId());
};
//-----------------------------------------------------------------------------
...
CGMZ_Profession.prototype.expForLevel = function(level) {
	const data = this.professionData();
	if(level <= 1) return 0;
	if(level > this._maxLevel) return this.expForLevel(this._maxLevel);
	if(!data.usingExpCurve) return data.expArray[level - 2]; // level - 2 since 0 not level and 1 lowest level possible
	const basis = data.expArray[0];
	const extra = data.expArray[1];
	const acc_a = data.expArray[2];
	const acc_b = data.expArray[3];
	if(acc_b === 0) acc_b = 1;
...
CGMZ_Profession.prototype.changeDiscoveredStatus = function(discovered) {
	if(discovered && !this._discovered) {
		if(Imported.CGMZ_ToastManager) this.setupDiscoverToast();
	}
...
CGMZ_Profession.prototype.levelUp = function() {
	this._level++;
	if(Imported.CGMZ_ToastManager) this.setupLevelUpToast();
...
CGMZ_Profession.prototype.doLevelUpEffects = function() {
	const data = this.professionData();
	if(data && SceneManager._scene.constructor.name === "Scene_Map") {
		this.showLevelUpBalloon();
...
//-----------------------------------------------------------------------------
CGMZ_Profession.prototype.showLevelUpBalloon = function() {
	const data = this.professionData();
	if(Imported.CGMZ_InfiniteBalloons && data.balloonIcon > 0) {
		$gameTemp.requestBalloon($gamePlayer, 0, data.balloonIcon);
	} else if(data.balloonId > 0) {
		$gameTemp.requestBalloon($gamePlayer, data.balloonId);
	}
};
//-----------------------------------------------------------------------------
// Show animation on level up
//-----------------------------------------------------------------------------
CGMZ_Profession.prototype.showLevelUpAnimation = function() {
	const data = this.professionData();
	if(data.animationId) $gameTemp.requestAnimation([$gamePlayer], data.animationId);
};
//-----------------------------------------------------------------------------
// Level Down
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
// Set up level up toast
//-----------------------------------------------------------------------------
CGMZ_Profession.prototype.setupLevelUpToast = function() {
	const data = this.professionData();
	const toast = $cgmzTemp.getToastObjectFromPreset(data?.levelUpToastPreset || CGMZ.Professions.LevelUpToast);
	if(data && toast) {
		toast.lineOne = toast.lineOne.replace('%name', this.getDisplayName()).replace('%color', data.color).replace('%actor', this.getActorName() + this.getNameSeparator()).replace('%level', this._level);
		toast.lineTwo = toast.lineTwo.replace('%name', this.getDisplayName()).replace('%color', data.color).replace('%actor', this.getActorName() + this.getNameSeparator()).replace('%level', this._level);
		if(data.hasToastSoundEffect()) toast.SE = data.getToastSoundEffect();
		$cgmzTemp.createNewToast(toast);
	}
};
//-----------------------------------------------------------------------------
// Set up discover toast
//-----------------------------------------------------------------------------
CGMZ_Profession.prototype.setupDiscoverToast = function() {
	const data = this.professionData();
	const toast = $cgmzTemp.getToastObjectFromPreset(data?.discoverToastPreset || CGMZ.Professions.DiscoverToast);
	if(data && toast) {
		toast.lineOne = toast.lineOne.replace('%name', this.getDisplayName()).replace('%color', data.color).replace('%actor', this.getActorName() + this.getNameSeparator());
		toast.lineTwo = toast.lineTwo.replace('%name', this.getDisplayName()).replace('%color', data.color).replace('%actor', this.getActorName() + this.getNameSeparator());
		if(data.hasToastSoundEffect()) toast.SE = data.getToastSoundEffect();
		$cgmzTemp.createNewToast(toast);
	}
};
...
CGMZ_Profession.prototype.tryShowExpSprite = function(expAmount) {
	...
	if(data._iconIndex) string += `\\i[${data._iconIndex}]`;
	string += `\\c[${data.color}]${this.getDisplayName()}\\c[0]${CGMZ.Professions.FloatPostText}`;
...
CGMZ_ProfessionTemp.prototype.initialize = function(profession) {
	...
	this.picture = profession.Picture;
	this._iconIndex = Number(profession.Icon);
	this.usingExpCurve = (profession["Use Experience Curve?"] === 'true');
	...
	this.levelUpToastPreset = profession["Level Up Toast Preset"];
	this.discoverToastPreset = profession["Discover Toast Preset"];
	this.expArray = CGMZ_Utils.parseJSON(profession["Experience Curve"], [30,20,30,30], "[CGMZ] Professions", `Your profession with ${profession.Name} had invalid JSON for the Experience Curve parameter.`).map(x => Number(x));
...
//=============================================================================
//-----------------------------------------------------------------------------
// Also initialize profession data
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
// Check for new professions after loading saved game
...
CGMZ_Scene_Professions.prototype.createListWindow = function() {
	...
	if(!this._categoryWindow && !this._includePartyWide) this._listWindow.setItem(this._actorIds[0]);
...
CGMZ_Window_ProfessionTotal.prototype.initialize = function(rect) {
	...
	if(Imported.CGMZ_WindowSettings && CGMZ.Professions.TotalWindowSettings) this.CGMZ_setWindowSettings(CGMZ.Professions.TotalWindowSettings);
	if(Imported.CGMZ_WindowBackgrounds && CGMZ.Professions.TotalWindowBackground) this.CGMZ_setWindowBackground(CGMZ.Professions.TotalWindowBackground);
	this._actorId = 0;
	this.refresh();
};
//-----------------------------------------------------------------------------
...
CGMZ_Window_ProfessionCategory.prototype.initialize = function(rect, actorIds, includePartyWide) {
	...
	if(Imported.CGMZ_WindowSettings && CGMZ.Professions.CategoryWindowSettings) this.CGMZ_setWindowSettings(CGMZ.Professions.CategoryWindowSettings);
	if(Imported.CGMZ_WindowBackgrounds && CGMZ.Professions.CategoryWindowBackground) this.CGMZ_setWindowBackground(CGMZ.Professions.CategoryWindowBackground);
...
CGMZ_Window_ProfessionCategory.prototype.maxCols = function() {
	return Math.min(CGMZ.Professions.MaxCategoryColumns, this.maxItems());
};
//-----------------------------------------------------------------------------
// Max items
//-----------------------------------------------------------------------------
...
CGMZ_Window_ProfessionList.prototype.initialize = function(rect) {
	Window_Selectable.prototype.initialize.call(this, rect);
	if(Imported.CGMZ_WindowSettings && CGMZ.Professions.ListWindowSettings) this.CGMZ_setWindowSettings(CGMZ.Professions.ListWindowSettings);
	if(Imported.CGMZ_WindowBackgrounds && CGMZ.Professions.ListWindowBackground) this.CGMZ_setWindowBackground(CGMZ.Professions.ListWindowBackground);
	this._actorId = 0;
};
//-----------------------------------------------------------------------------
// Max items
...
CGMZ_Window_ProfessionList.prototype.drawItem = function(index) {
	...
	const string = CGMZ.Professions.ListWindowText.replace('%color', `\\c[${profTemp.color}]`).replace('%name', item.getDisplayName()).replace('%level', item._level).replace('%maxlevel', item._maxLevel);
...
CGMZ_Window_ProfessionDisplay.prototype.initialize = function(rect) {
	...
	if(Imported.CGMZ_WindowSettings && CGMZ.Professions.DisplayWindowSettings) this.CGMZ_setWindowSettings(CGMZ.Professions.DisplayWindowSettings);
	if(Imported.CGMZ_WindowBackgrounds && CGMZ.Professions.DisplayWindowBackground) this.CGMZ_setWindowBackground(CGMZ.Professions.DisplayWindowBackground);
...
CGMZ_Window_ProfessionDisplay.prototype.refresh = function() {
	...
	if(!professionTemp) return;
	this.setupWindowForNewEntry();
	this._imageOffsetInfo = {x:0, y:0, width:0, height:0};
	if(professionTemp.picture) {
...
CGMZ_Window_ProfessionDisplay.prototype.drawProfessionInfo = function() {
	...
	for(const infoType of CGMZ.Professions.DisplayInfo) {
		switch(infoType) {
			case "Name": this.drawProfessionName(); break;
			case "Image":
				if(professionTemp.picture) {
				...
				break;
			case "Level": this.drawProfessionLevel(); break;
			case "Exp": this.drawProfessionExperience(); break;
			case "Exp To Level": this.drawProfessionExperienceToLevel(); break;
			case "Description": this._neededHeight += this.drawProfessionDescription(); break;
			case "Custom Info":
			...
			case "Custom Header":
				...
				if(header) {
					this._neededHeight += this.CGMZ_drawHeader(header, this._neededHeight, CGMZ.Professions.HeaderColor1, CGMZ.Professions.HeaderColor2);
				}
				break;
			case "Recipes Header":
				if(Imported.CGMZ_Crafting) {
					this._neededHeight += this.CGMZ_drawHeader(CGMZ.Professions.RecipeHeaderText, this._neededHeight, CGMZ.Professions.HeaderColor1, CGMZ.Professions.HeaderColor2);
				}
				break;
			case "Recipes Header":
				if(Imported.CGMZ_Crafting) {
			...
			case "Recipes":
				if(Imported.CGMZ_Crafting) {
					...
					if(recipes.length > 0) {
						...
						this._neededHeight += this.CGMZ_drawTextLine(CGMZ.Professions.NoRecipesText, 0, this._neededHeight, this.contents.width, 'left');
					}
				}
				break;
			case "Unlearned Recipes Header":
				if(Imported.CGMZ_Crafting) {
					this._neededHeight += this.CGMZ_drawHeader(CGMZ.Professions.UnlearnedRecipeHeaderText, this._neededHeight, CGMZ.Professions.HeaderColor1, CGMZ.Professions.HeaderColor2);
				}
				break;
			...
			case "Custom Space": this._neededHeight += CGMZ.Professions.CustomSpace; break;
		}
	}
...
CGMZ_Window_ProfessionDisplay.prototype.drawProfessionName = function() {
	...
	this._neededHeight += this.CGMZ_drawTextLine(this._profession.getDisplayName(), 0, this._neededHeight, this.contents.width, 'center');
...
CGMZ_Window_ProfessionDisplay.prototype.loadProfessionImage = function() {
	const professionTemp = $cgmzTemp.getProfessionTempData(this._profession._name);
	const imgData = CGMZ_Utils.getImageData(professionTemp.picture, "img");
...
CGMZ_Window_ProfessionDisplay.prototype.drawProfessionLevel = function() {
	...
	this._neededHeight += this.drawProfessionStandardLine(descriptor1, descriptor2, x, this.contents.width-x);
};
//-----------------------------------------------------------------------------
...
CGMZ_Window_ProfessionDisplay.prototype.drawProfessionStandardLine = function(descriptor1, descriptor2, x, width) {
	...
	return this.CGMZ_drawTextLine(string, x, this._neededHeight, width, 'left');
};
//-----------------------------------------------------------------------------
// Draw Large icon
//-----------------------------------------------------------------------------
